...
inline OutputClass horrible_cast(const InputClass input) {
  ...
  typedef int ERROR_CantUseHorrible_cast[sizeof(InputClass) == sizeof(u)
    && sizeof(InputClass) == sizeof(OutputClass) ? 1 : -1] __attribute__((unused));
  u.in = input;
  return u.out;
}
...
struct SimplifyMemFunc {
  ...
  inline static GenericClass *Convert(X*, XFuncType, GenericMemFuncType&) {
    ...
    typedef char ERROR_Unsupported_member_function_pointer_on_this_compiler[N-100] __attribute__((unused));
    return 0;
  }
};
...
template<>
struct SimplifyMemFunc< SINGLE_MEMFUNCPTR_SIZE + sizeof(int) > {  // NOLINT
  template <class X, class XFuncType, class GenericMemFuncType>
  inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
    GenericMemFuncType &bound_func) {
    ...
    typedef int ERROR_CantUsehorrible_cast[sizeof(function_to_bind) == sizeof(u.s) ? 1 : -1] __attribute__((unused));
...
template <>
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 2 * sizeof(int) > {  // NOLINT
  template <class X, class XFuncType, class GenericMemFuncType>
  inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
    GenericMemFuncType &bound_func) {
    union {
    ...
    typedef int ERROR_CantUsehorrible_cast[sizeof(function_to_bind) == sizeof(u.s)
      ...
      && sizeof(u2.virtfunc) == sizeof(u2.s) ? 1 : -1] __attribute__((unused));
...
template <>
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3 * sizeof(int) > {  // NOLINT
  template <class X, class XFuncType, class GenericMemFuncType>
  inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
    GenericMemFuncType &bound_func) {
    ...
    typedef char ERROR_VC6CompilerBug[-100] __attribute__((unused));
    return 0;
  }
};
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3 * sizeof(int) > {  // NOLINT
  ...
  inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
    ...
    // Check that the horrible_cast will work
    typedef int ERROR_CantUsehorrible_cast[sizeof(XFuncType) == sizeof(u.s) ? 1 : -1] __attribute__((unused));
    u.func = function_to_bind;
    bound_func = u.s.funcaddress;
    int virtual_delta = 0;
    if (u.s.vtable_index) {
...
class ClosurePtr : public DelegateMemento {
  ...
  // support static_cast between void * and function pointers.
    ...
    inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker, StaticFuncPtr function_to_bind) {
      ...
      typedef int ERROR_CantUseEvilMethod[sizeof(GenericClass *) == sizeof(function_to_bind) ? 1 : -1] __attribute__((unused));  // NOLINT
    ...
    inline UnvoidStaticFuncPtr GetStaticFunction() const {
      ...
      // and data pointers have different sizes.
      // If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
      typedef int ERROR_CantUseEvilMethod[sizeof(UnvoidStaticFuncPtr) == sizeof(this) ? 1 : -1] __attribute__((unused));
...
class Delegate0 {
  ...
  public:
    ...
    Delegate0& operator=(DesiredRetType (*function_to_bind)()) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate1 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate1& operator=(DesiredRetType (*function_to_bind)(Param1 p1)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate2 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate2& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate3 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate3& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate4 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate4& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate5 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate5& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate6 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate6& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate7 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate7& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
      Bind(function_to_bind);
      return *this;
    }
...
class Delegate8 {
  ...
  public:
    ...
    // for efficiency, prevent creation of a temporary
    Delegate8& operator=(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
      Bind(function_to_bind);
      return *this;
    }
